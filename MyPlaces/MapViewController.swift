...
class MapViewController: UIViewController {
    ...
    var metresInRegion = 1000
    var incomeSegueIdentifier = ""
    var placeCoordinate: CLLocationCoordinate2D?
    var directionsArray: [MKDirections] = []
    var previouLocation: CLLocation? {
        didSet {
    ...
    private func getDIrections() {
        ...
        previouLocation = CLLocation(latitude: location.latitude, longitude: location.longitude)
    ...
    private func showUserLocation() {
        ...
        if let location = locationManager.location?.coordinate {
            let region = MKCoordinateRegion(center: location,
                                            latitudinalMeters: metresInRegion,
                                            longitudinalMeters: metresInRegion)
    ...
    private func startTrackingUserLocation() {
        ...
        guard let previousLocation = previouLocation else { return }
        let center = getCenterLocation(for: mapView)
        
        guard center.distance(from: previousLocation) > 50 else { return }
        
        self.previouLocation = center
...
extension MapViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, regionDidChangeAnimated animated: Bool) {
        ...
        if incomeSegueIdentifier == "showPlace", previouLocation != nil {
            DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
                self.showUserLocation()
            }
        }
